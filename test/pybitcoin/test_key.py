...
class TestAddressMethods(unittest.TestCase):
    ...
    def test_address_from_pubkey(self):
        self.assertEquals(
            key.address_from_pubkey(
                '\x04\x01\x00\xb9\xce\x1a\xcfg\x16\xa2\xd6Os\xb2\xa6%\xf2\xc1\x0c\xe9\x19\xe5(\xa9?`Z\xf1\xd7='
                'M[AY\x99\xff\xde\xf8\x89\xd9m\xccB"\x0e\xd9ys\xb0S{k\x95\xa3\xec\\\xa2\xaf\x96B`\x1fK\x12\xe8'),
    ...
    def test_address_from_compressed_pubkey(self):
        self.assertEquals(
            key.address_from_pubkey(
                '\x02\x01\x00\xb9\xce\x1a\xcfg\x16\xa2\xd6Os\xb2\xa6%\xf2\xc1\x0c\xe9\x19\xe5(\xa9?`Z\xf1\xd7=M[A'),
...
class TestKey(unittest.TestCase):
    ...
    def test_encode_privkey_compressed(self):
        self.assertEqual(
            key.encode_privkey_compressed(int('7F3B6EAF1C8C3BFD8B0727B979746A932B6B9F9489898379DD65C1E3CCC3B4DF', 16)),
    ...
    def test_encode_privkey2(self):
        ...
        self.assertEqual(key.encode_privkey(priv), '5Hskz9wmd3fnTPVnmPhaLtvaumjQU9ycCYWwkiRPgdQ1B4PcoAf')

    def test_encode_privkey2_compressed(self):
        priv = 3566362552192297244228444858243043761472313190548212544975902619635471184649L
        self.assertEqual(key.encode_privkey_compressed(priv), 'KwV39GUjx6nBdUJ4zwC6ApBWfvSAarcrMx7Afwpf7ueXm5Wuc1r2')
    ...
    def test_encode_pub_compressed(self):
        pub = key.priv_to_pub(
            key.decode_privkey('5JnKZDMUAddiGgFjWiHNVrX5pxGcEJ1miscs2Xhy7f9BrGffrps'))
        self.assertEquals(key.encode_pub_compressed(pub),
