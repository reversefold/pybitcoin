...
def upgrade():
    ...
    op.execute(CreateSequence(Sequence('block_id')))
    ...
    op.execute(CreateSequence(Sequence('transaction_id')))
    ...
    op.execute(CreateSequence(Sequence('txin_id')))
    ...
    op.execute(CreateSequence(Sequence('txout_id')))
